    ...
    <div class="row">
        <form action="employee" method="post">
            ...
            <div class="mb-3">
                ...
                <div class="form-check">
                    <input type="radio" class="form-check-input" id="radio6" name="educationDegreeId" value="4">Nhân viên
                    <label class="form-check-label" for="radio1"></label>
                </div>
            </div>
            <div class="mb-3">
